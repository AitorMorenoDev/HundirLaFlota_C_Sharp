...
namespace HundirLaFlota
{
    class Tablero
    {
        ...
        //Método para mostrar el tablero del jugador mediante logs:
        public void LogTableroJugador()
        {
            for (int i = 0; i < FILAS; i++)
            {
                string filaLog = "";
        ...
        */
        ...
        //Método para mostrar la información del tablero del oponente mediante logs:
        public void LogTableroOponente()
        {
            for (int i = 0; i < FILAS; i++)
            {
                string filaLog = "";
        ...
        */
        ...
        public string Turnos(int fila, int columna, int turno)
        {
            ...
            //Mostramos la información del tablero del oponente con las casillas bombardeadas mediante logs:
            for (int i=0; i < FILAS; i++)
            {
                for (int j = 0; j < COLUMNAS; j++)
                {
                    ...
                    {
                        char casillaEstado = casillas[i, j].GetEstado();
                        string logMessage = casillaEstado + " ";

                        if (casillaEstado == 'X')
                        {
                            Log.InfoFormat("Fila {0}, Columna {1}: Tocado", i, j);
                        }
                        else if (casillaEstado == '=')
                        {
                            Log.InfoFormat("Fila {0}, Columna {1}: Agua", i, j);
                        }
                        else if (casillaEstado == 'O')
                        {
                            Log.InfoFormat("Fila {0}, Columna {1}: Barco", i, j);
                        }
                    }
                }
            }
